...
class ProjectListByPersonPage extends StatefulWidget {
  const ProjectListByPersonPage({
    super.key,
  ...
  static const routePath = 'projects/by-person/:personId';
  static const routeName = 'projects-by-person';

  @override
  State<ProjectListByPersonPage> createState() => _ProjectListByPersonPageState();
}

class _ProjectListByPersonPageState extends State<ProjectListByPersonPage> {
